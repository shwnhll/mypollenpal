...
function TrendsContent({ pollenData, cityData }) {
  return (
    <div>
      <h3 style={{ marginBottom: '1.5rem', color: '#f5f5f5' }}>Seasonal Trends</h3>
      <div style={{
        display: 'grid',
        ...
        <div style={{
          ...
          <h4 style={{ marginBottom: '1rem', color: '#d4af37' }}>Season Progress</h4>
          <div style={{ marginBottom: '1.5rem' }}>
            <div style={{ display: 'flex', justifyContent: 'space-between', marginBottom: '0.5rem' }}>
              <span>Tree Season</span>
              <span style={{ color: '#d4af37' }}>75% Complete</span>
            </div>
            <div style={{
              width: '100%',
              height: '8px',
          ...
          <p style={{ fontSize: '0.9rem', color: '#b8b8b8' }}>
            Peak tree pollen season is nearly over in {cityData.name}. 
            Grass season typically begins in late spring.
          </p>
        </div>
        ...
        <div style={{
          ...
          <h4 style={{ marginBottom: '1rem', color: '#d4af37' }}>This Week</h4>
          <p style={{ fontSize: '0.9rem', color: '#b8b8b8', marginBottom: '1rem' }}>
            Expect variable pollen levels this week due to changing weather patterns.
            Midweek shows the highest levels.
          </p>
          <div style={{ fontSize: '0.85rem', color: '#10b981' }}>
            💡 Best outdoor days: Thursday and Friday
          </div>
        </div>
      </div>
    </div>
...
function SourcesContent({ cityData }) {
  return (
    <div>
      ...
      <div style={{
       ...
       <div style={{
         ...
         <h4 style={{ marginBottom: '1rem', color: '#10b981' }}>🏞️ Best Low-Pollen Spots</h4>
         <div style={{ fontSize: '0.9rem', color: '#b8b8b8' }}>
           <div style={{ marginBottom: '0.5rem' }}>• Indoor shopping centers</div>
           <div style={{ marginBottom: '0.5rem' }}>• Libraries and community centers</div>
           <div style={{ marginBottom: '0.5rem' }}>• Museums and cultural venues</div>
           <div>• Indoor recreational facilities</div>
         </div>
       </div>
       ...
       <div style={{
         ...
         <h4 style={{ marginBottom: '1rem', color: '#ef4444' }}>⚠️ Avoid During High Pollen</h4>
         <div style={{ fontSize: '0.9rem', color: '#b8b8b8' }}>
           <div style={{ marginBottom: '0.5rem' }}>• Heavily wooded parks</div>
           <div style={{ marginBottom: '0.5rem' }}>• Golf courses and open fields</div>
           <div style={{ marginBottom: '0.5rem' }}>• Outdoor farmers markets</div>
           <div>• Construction/landscaping areas</div>
         </div>
       </div>
       ...
       <div style={{
         ...
         <h4 style={{ marginBottom: '1rem', color: '#d4af37' }}>💡 Local Resources</h4>
         <div style={{ fontSize: '0.9rem', color: '#b8b8b8' }}>
           <div style={{ marginBottom: '0.5rem' }}>• Local pharmacies for allergy meds</div>
           <div style={{ marginBottom: '0.5rem' }}>• Check weather stations for updates</div>
           <div style={{ marginBottom: '0.5rem' }}>• Join community allergy groups</div>
           <div>• Follow local health department alerts</div>
         </div>
       </div>
     </div>
     ...
     <div style={{
       ...
       <h4 style={{ marginBottom: '1rem', color: '#10b981' }}>🌟 Pro Tips for {cityData.name}</h4>
       <div style={{ fontSize: '0.9rem', color: '#f5f5f5' }}>
         <div style={{ marginBottom: '0.5rem' }}>• Check pollen counts before planning outdoor activities</div>
         <div style={{ marginBottom: '0.5rem' }}>• Keep car windows closed and use recirculate mode</div>
         <div style={{ marginBottom: '0.5rem' }}>• Shower and change clothes after being outdoors</div>
         <div style={{ marginBottom: '0.5rem' }}>• Consider air purifiers for your home</div>
         <div>• Plan outdoor exercise for late afternoon when pollen settles</div>
       </div>
     </div>
   </div>
 )
